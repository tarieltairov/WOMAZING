...
export function InputSection(){
    ...
    const handleSubmit = (event) =>{
        ...
        } else event.preventDefault() || console.log('Отправка формы', { name, email, tell, message })
        setIsSent(true);
