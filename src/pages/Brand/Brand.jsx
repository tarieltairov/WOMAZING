...
import ideaWoman from "../../assets/images/Idea-women.png";
        ...
        <div className={brandStyles.brand__header}>
          <div className={brandStyles.brand__header_title}>
            ...
            <div className={brandStyles.brand__nav}>
              <p>Главная</p>
              <span className={brandStyles.nouneym}>-</span>
              <p className={brandStyles.brand__p}>О бренде</p>
            </div>
          </div>
        </div>

        <div className={brandStyles.idea}>
          <img src={ideaWoman} alt="idea-women" />
